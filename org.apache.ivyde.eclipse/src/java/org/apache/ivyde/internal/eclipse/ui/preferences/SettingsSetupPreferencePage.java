...
import org.apache.ivyde.internal.eclipse.ui.SettingsSetupEditor;
...
public class SettingsSetupPreferencePage extends PreferencePage implements IWorkbenchPreferencePage {
    ...
    public boolean performOk() {
        ...
        helper.setSettingsSetup(settingsEditor.getIvySettingsSetup());
        return true;
    }

    protected void performDefaults() {
        settingsEditor.init(PreferenceInitializer.DEFAULT_SETTINGS_SETUP);
    }
}
